...
export default defineSchema({
  ...
  webhookEvents: defineTable({
    ...
    createdAt: v.number(),
  }).index("by_eventId", ["eventId"]).index("by_reference", ["reference"]),
  ...
  walletLedger: defineTable({
    ...
    description: v.optional(v.string()),
    createdAt: v.number(),
  }).index("by_eventId", ["eventId"]).index("by_reference", ["reference"]).index("by_walletId", ["walletId"]).index("by_user", ["userId"]),
});
